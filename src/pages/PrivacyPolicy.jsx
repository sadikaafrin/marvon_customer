            ...
            <div style={{
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    <div style={{
                        ...
                        <i className="ri-shield-keyhole-line" style={{
                            fontSize: '40px',
                            color: '#fff'
                        }}></i>
                    </div>
                    ...
                    <p style={{
                        ...
                        Please read our privacy policy carefully before using this website.
                    </p>
                </div>
            </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{ __html: footerContent?.privacy_policy }}
                        ></div>
                    </div>
